...
class ActivityOwnerNotification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        headerProfileToolbar = findViewById(R.id.headerProfileToolbar)
        ...
        bottomNav.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                ...
                R.id.nav_reviews -> {
                    ...
                    startActivity(
                        Intent(this, OwnerReviewsActivity::class.java)
                    )
                    true
                }
                ...
                R.id.nav_performance -> {
                    ...
                    startActivity(
                        Intent(this, ActivityOwnerPerformance::class.java)
                    )
                    true
                }
            ...
            .addOnSuccessListener { doc ->
                ...
                try {
                    ...
                    if (!base64.isNullOrEmpty()) {
                        ...
                        headerProfileToolbar.setImageResource(
